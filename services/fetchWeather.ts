import { WeatherDataInterface, weatherDataSchema } from '../components/WeatherSearchForm/types';

export const fetchWeather = async (city: string, onWeatherData: (data: WeatherDataInterface) => void): Promise<void | null> => {
...
export const fetchWeatherById = async (cityId: number): Promise<WeatherDataInterface | null> => {
